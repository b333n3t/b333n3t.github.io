...
<head>
  ...
  <style>
    ...
    /* NEW: Titel unter YT-Thumb */
    .grid-seen .card .yt-title{display:block;margin-top:4px;font-size:.95rem;font-weight:600}
  </style>
</head>
<body>
  <header class="header">
        ...
        card.addEventListener('click', () => {
          try {
            ...
            if (src.toLowerCase().endsWith('.mp4')) {
              ...
              iframe.loading = 'lazy';
              iframe.title = 'Video';
              // NEW: Falls YouTube, echten Titel setzen
  ...
  document.addEventListener('DOMContentLoaded', () => {
    try {
      ...
      console.error('IG thumbs error:', err);
    }
  });
  </script>
  ...
  <!-- NEW: YouTube Titel automatisch holen (oEmbed, ohne API-Key) -->
  <script>
  document.addEventListener('DOMContentLoaded', () => {
    try {
      ...
      ytCards.forEach((card) => {
        ...
        fetch(url, { mode: 'cors' })
          ...
          .catch(() => { /* still bleiben, wenn geblockt */ });
      });
    } catch (err) {
      console.error('YT titles error:', err);
    }
  });
  </script>
  ...
  document.addEventListener('DOMContentLoaded', () => {
    try {
      ...
      console.error('Intro thumb error:', err);
    }
  });
  </script>
</body>
